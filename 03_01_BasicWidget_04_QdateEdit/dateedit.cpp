    ...
    : QWidget(parent)
{
    ...
    lbl[1] = new QLabel(dt3.toString(),this);
    lbl[1]->setGeometry(10, 150, 150, 30);

    if(QDate::isValid(2011, 6, 27))
        qDebug("2013.06.27 true");
    else {
        qDebug("2013.06.27 false");
    }
    ...
    lbl[2] = new QLabel(QString("Long : %1. Short : %2").arg(strDateLong).arg(strDateShort),this);
